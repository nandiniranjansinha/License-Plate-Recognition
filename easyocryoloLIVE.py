...
# Video for inferencing

input_video = 'vehicle_video.mp4'
output_video = 'output_with_licensev4.mp4'

cap = cv2.VideoCapture(input_video)
# if it was 0 instead of input_video
# live cam would be captured
            ...
            if plate_crop.size > 0:
                ...
                if oy2 <= frame.shape[0] and ox2 <= frame.shape[1]:
                    ...
                    if stable_text:
                        ...
                        cv2.putText(frame, stable_text, (ox1, oy1 - 20),
                                    cv2.FONT_HERSHEY_SIMPLEX, 0.8, (255,255,255), 3) # White text
